...
export class VerificationTokenController {
  ...
  static async createVerificationToken(req: Request<{}, {}, CreateVerificationTokenRequest>, res: Response) {
    try {
  ...
  static async useVerificationToken(req: Request<{ identifier: string; token: string }>, res: Response) {
    try {
  ...
  static async getVerificationToken(req: Request<{ identifier: string; token: string }>, res: Response) {
    try {
      const { identifier, token } = req.params;
