...
import type {
	...
	GetAuthenticatorsQuery,
} from "../types/auth.js";

export class AuthenticatorController {
	// Create authenticator (WebAuthn)
	static async createAuthenticator(
		req: Request<{}, {}, CreateAuthenticatorRequest>,
		res: Response,
	) {
		try {
	...
	static async getAuthenticatorsByUserId(
	...
	static async updateAuthenticatorCounter(
		req: Request<{ credentialID: string }, {}, UpdateAuthenticatorRequest>,
		res: Response,
	) {
		try {
			const { credentialID } = req.params;
	...
	static async deleteAuthenticator(
		req: Request<{ credentialID: string }>,
		res: Response,
	) {
		try {
	...
	static async getAllAuthenticators(
		req: Request<{}, {}, {}, GetAuthenticatorsQuery>,
		res: Response,
	) {
		try {
