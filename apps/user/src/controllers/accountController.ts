...
export class AccountController {
  ...
  static async linkAccount(req: Request<{}, {}, CreateAccountRequest>, res: Response) {
    try {
  ...
  // Unlink account
  static async unlinkAccount(req: Request<{ provider: string; providerAccountId: string }>, res: Response) {
    try {
  ...
  static async getAccount(req: Request<{ provider: string; providerAccountId: string }>, res: Response) {
    try {
      const { provider, providerAccountId } = req.params;
  ...
  static async getUserByAccount(req: Request<{ provider: string; providerAccountId: string }>, res: Response) {
    try {
      const { provider, providerAccountId } = req.params;
  ...
  static async getAllAccounts(req: Request<{}, {}, {}, GetAccountsQuery>, res: Response) {
    try {
  ...
  static async getAccountsByUserId(req: Request<{ userId: string }>, res: Response) {
    try {
