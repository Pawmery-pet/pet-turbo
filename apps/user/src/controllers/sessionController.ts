...
export class SessionController {
  // Create session
  static async createSession(req: Request<{}, {}, CreateSessionRequest>, res: Response) {
    try {
      const sessionData = req.body;

      // Validate required fields
      if (!sessionData.sessionToken || !sessionData.userId || !sessionData.expires) {
  ...
  static async getSessionAndUser(req: Request<{ sessionToken: string }>, res: Response) {
    try {
  ...
  // Update session
  static async updateSession(req: Request<{ sessionToken: string }, {}, UpdateSessionRequest>, res: Response) {
    try {
      const { sessionToken } = req.params;
  ...
  // Delete session
  static async deleteSession(req: Request<{ sessionToken: string }>, res: Response) {
    try {
      const { sessionToken } = req.params;
  ...
  static async getSession(req: Request<{ sessionToken: string }>, res: Response) {
    try {
      const { sessionToken } = req.params;
  ...
  static async getAllSessions(req: Request<{}, {}, {}, GetSessionsQuery>, res: Response) {
    try {
  ...
  static async getSessionsByUserId(req: Request<{ userId: string }>, res: Response) {
    try {
