export const landingData = {
  ...
  hero: {
    ...
    subtitle: "Keep your beloved pets close to your heart forever. Continue their beautiful story and cherish your ongoing bond.",
  ...
  features: [
    {
      ...
      description: "Keep your pet's unique personality and precious memories alive through their ongoing story"
    },
    {
      icon: "💬",
      title: "Continue the Bond",
      description: "Share moments and continue your beautiful relationship whenever your heart needs comfort"
    },
    {
      icon: "🌟",
      title: "Find Peace",
      description: "A gentle space to honor your pet's memory and find solace in your everlasting connection"
    }
  ],
  ...
  petTypes: [
    ...
    {
      name: "Other Pets",
      image: "https://images.unsplash.com/photo-1425082661705-1834bfd09dca?w=300&h=300&fit=crop&crop=face",
      alt: "Rabbit"
    }
  ],
  ...
  video: {
    ...
    subtitle: "Watch how we help preserve your pet's story and keep their memory alive",
  ...
  services: [
    {
      ...
      description: "Start preserving your pet's precious memories with our guided story creation process",
    ...
    },
    {
      ...
      description: "Discover and preserve your pet's unique personality through our detailed analysis",
    ...
    },
    {
      ...
      description: "Keep all your pet's stories and memories organized in one beautiful space",
  ...
  blog: [
    {
      ...
      excerpt: "Discover meaningful ways to keep your beloved pet's spirit alive in your heart and home.",
    ...
    },
    {
      ...
      excerpt: "Learn how to capture your pet's unique personality and create lasting memories.",
    ...
    },
    {
      ...
      excerpt: "Gentle guidance on processing grief and finding peace after losing a beloved companion.",
