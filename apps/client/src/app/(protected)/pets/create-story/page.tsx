...
export default function CreateStoryPage() {
	...
	const submitJobToServer = async () => {
		...
		try {
			...
			const pendingPets = JSON.parse(
				localStorage.getItem("pawmery-pending-pets") || "[]",
			);
			pendingPets.push({
	...
	const canProceed = () => {
		switch (currentStep) {
			...
			case 3:
				return formData.responses.length === surveyQuestions.length;
			case 4:
	...
	return (
		<div className="min-h-screen bg-gray-50">
				...
				<div className="max-w-4xl mx-auto px-4 py-4">
					...
					<div className="w-full bg-gray-200 rounded-full h-2">
						<div
							...
							style={{
								width: `${currentStep === 5 ? 100 : (currentStep / 4) * 100}%`,
							}}
						/>
					</div>
				</div>
			...
			<div className="max-w-4xl mx-auto px-4 py-8">
				{currentStep === 1 && (
					<PetInfoStep formData={formData} updateFormData={updateFormData} />
				)}
		...
		return (
			<div className="space-y-6">
				<div className="text-center">
					...
					<p className="text-gray-600">
						Preparing personalized questions for {formData.name}
					</p>
				</div>
				<div className="bg-white rounded-lg shadow p-8 text-center">
					<div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-600 mx-auto"></div>
					<p className="mt-4 text-gray-600">
						Getting questions ready for your {formData.breed}...
					</p>
				</div>
			</div>
		);
	...
	return (
		<div className="space-y-6">
			<div className="text-center">
				...
				<p className="text-gray-600">
					These questions help us understand their unique character
				</p>
			</div>
	...
	return (
		<div className="space-y-6">
			<div className="text-center">
				...
				<p className="text-gray-600">
					Please review the information you've provided for {formData.name}
				</p>
			</div>
			...
			<div className="bg-white rounded-lg shadow p-6 space-y-6">
				...
				<div>
					...
					<div className="bg-gray-50 p-4 rounded-lg">
						<p className="mb-2">
							<strong>Name:</strong> {formData.ownerInfo.ownerName}
						</p>
						<p className="mb-2">
							<strong>Email:</strong> {formData.ownerInfo.email}
						</p>
						{formData.ownerInfo.phone && (
							<p>
								<strong>Phone:</strong> {formData.ownerInfo.phone}
							</p>
						)}
					</div>
				</div>
...
function JobCreationSuccessStep({
	...
	return (
		<div className="space-y-6">
			<div className="text-center">
				<h2 className="text-2xl font-bold text-gray-900 mb-2">
					Your Pet's Story is Being Created!
				</h2>
				<p className="text-gray-600">
					We've started generating your pet's unique story.
				</p>
			</div>
			...
			<div className="bg-white rounded-lg shadow p-6 space-y-6">
				<div className="flex items-center space-x-4 p-4 bg-green-50 rounded-lg">
					...
					<div>
						...
						<p className="text-sm text-green-600">
							Estimated Wait Time: {jobCreation.estimatedWaitTime} seconds
						</p>
					</div>
				</div>
				...
				<div className="border-t pt-6">
					...
					<p className="text-gray-600">
						Your pet's story is being generated. You can check its status in
						your dashboard. Once it's ready, you'll receive an email
						notification.
					</p>
					<button
						onClick={onFinish}
