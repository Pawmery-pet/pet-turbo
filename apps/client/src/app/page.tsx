	...
	return (
		<div className="text-center">
			...
			<p className="text-gray-600 mb-8">
				Continue the beautiful story with your beloved pet. Keep their memory
				alive, share moments together, and find comfort in your ongoing bond.
			</p>
			<Link
				href="/login"
			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
				...
				>
					...
					<p className="text-gray-600 text-sm">
						View your forever friends and recent moments
					</p>
				</Link>
				...
				>
					...
					<p className="text-gray-600 text-sm">
						Continue your pet's story and keep their memory alive
					</p>
				</Link>
		...
		<div className="min-h-screen bg-gray-50">
			<div className="max-w-4xl mx-auto px-4 py-16">
				...
				<div className="bg-white rounded-lg shadow-lg p-8">
					{user ? <SignOut>{`Welcome back, ${user}!`}</SignOut> : <SignIn />}
				</div>
						...
						<div className="grid grid-cols-1 md:grid-cols-3 gap-8">
							<div className="text-center">
								...
								<p className="text-gray-600">
									Keep your pet's unique personality and precious memories alive
									through their ongoing story
								</p>
							</div>
							<div className="text-center">
								<div className="text-4xl mb-4">💬</div>
								...
								<p className="text-gray-600">
									Share moments and continue your beautiful relationship
									whenever your heart needs comfort
								</p>
							</div>
							<div className="text-center">
								<div className="text-4xl mb-4">🌟</div>
								...
								<p className="text-gray-600">
									A gentle space to honor your pet's memory and find solace in
									your everlasting connection
								</p>
							</div>
						</div>
					</div>
